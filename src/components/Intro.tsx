  ...
  return (
    <>
      <div className="flex flex-col items-center text-center">
        <Image
          src="/images/git_beetle.png"
          alt="Beetle"
          width={250}
          height={250}
          className="rounded-xl mb-4"
        />
        <h2 className="text-2xl font-bold text-white mb-2">Beetle</h2>
        <p className="text-sm text-gray-400 mb-6">OpenSource AI GitHub Wrapper</p>
      </div>
      <SignUpForm />
      
      {/* DropdownMenu removed from here for global top left placement */}

      <div className="mt-6 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
      <IconLink href="https://x.com/RAWx18_dev" icon={XIcon} compact>
        @RAWx18_dev
      </IconLink>
        <IconLink href="https://github.com/RAWx18/Beetle" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Built by the OpenSource community 🐞
    </p>
  )
}